...
def test_passthrough_strategy():
    ...
    assert strategy.process_data(10.5) == (10.5, 1, True)
    assert strategy.process_data(20.0) == (20.0, 1, True)
...
def test_tree_delta_avg_threshold():
    ...
    strategy.process_data(10.0)
    assert strategy.process_data(10.0) == (10.0, 2, True) # Avg=10.0
    ...
    assert strategy.process_data(12.0) == (2.0, 2, False)
...
def test_tree_delta_avg_reset():
    ...
    assert strategy.process_data(30.0) == (25.0, 2, True) # (20+30)/2
